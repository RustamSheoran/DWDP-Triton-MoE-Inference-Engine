...
class PrefetchWorker final {
 public:
  PrefetchWorker(WeightManager&, DoubleBufferedStaging&, CUDAEventPool&, PrefetchQueue&, CUDAStreamPool&);
 ...
 private:
  void run() noexcept;
  WeightManager& weights_; DoubleBufferedStaging& staging_; CUDAEventPool& events_; PrefetchQueue& queue_; CUDAStreamPool& streams_;
