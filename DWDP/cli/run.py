...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Run text generation through a DWDP runtime wrapper."
    )
    parser.add_argument(
        "--model", required=True, help="Hugging Face model path or identifier."
    )
...
def main(argv: list[str] | None = None) -> None:
    ...
    tokenizer = (
        getattr(runtime.adapter, "tokenizer", None)
